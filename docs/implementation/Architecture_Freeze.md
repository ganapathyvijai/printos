...
Note: AR-005 is now **Resolved** (see Section 10.4): Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff (Option B, 2026-09-26), per `../decisions/Architecture_Review_Register.md` and `../blueprint/14_Quotation_Engine.md`, Version 0.1; the Quotation layer remains Excluded pending Blueprint 14's own review, resolution of the coupled AR-010 dependency, and a separate scoped implementation-authorization decision, not pending document-strategy selection.

Note: AR-006 is now **Resolved** (see Section 10.5): Material is a Custom PrintOS master record linked to native Item; Substrate is a specialization of Material; Product Template is its own Custom PrintOS artifact, independent of Material and Item (Option C, 2026-09-26), per `../decisions/Architecture_Review_Register.md` and `../blueprint/17_Inventory_Model.md`, Version 0.1, formalized in `../decisions/ADR-016-Item-Material-Product-Template-Mapping.md`. This layer remains Excluded pending Blueprint 17's own review, Substrate's downstream DocType-structure design, and a separate scoped implementation-authorization decision, not pending ownership-boundary selection. This resolution satisfies AR-006's own decision gate only — it does not promote any frozen scope, authorize implementation, authorize runtime validation, or complete any milestone.
...
| [../blueprint/08_Master_Data_Model.md](../blueprint/08_Master_Data_Model.md) | 1.1 | Frozen with explicit exclusions — business-level master-data model Frozen; it does not define ERPNext DocType ownership. Substrate's specialization-of-Material question is now Resolved (AR-006, Option C, 2026-09-26; ADR-016) as a business-model matter, per this document's own Version 1.1 bounded correction; the document's Frozen classification is unchanged, and ERPNext DocType-level ownership implementation remains deferred to `17_Inventory_Model.md` and downstream design. Machine and Machine Profile's own ownership question is Resolved (AR-004, Option C, 2026-09-20) |
...
| [../architecture/ERPNext_Gap_Analysis.md](../architecture/ERPNext_Gap_Analysis.md) | 0.1 | The 28 gap records and their classifications | Gap sizing that depends on AR-gated ownership | AR-010 (AR-004, AR-005, and AR-006 Resolved and removed from this list) |
...
**10.4 Quotation strategy** — AR-005 is Resolved (Option B, 2026-09-26: Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff), per `../blueprint/14_Quotation_Engine.md`, Version 0.1. This layer may now be considered for inclusion in a future Frozen baseline revision; it is not automatically promoted by this correction alone. Quotation Line's exact target and Cost Estimate's detailed cost-breakdown design remain deferred to a downstream DocType-design task, and AR-010 remains Open and should be resolved before that design, to avoid later rework.

**10.5 Material and Product Template ownership** — AR-006 is Resolved (Option C, 2026-09-26; [ADR-016-Item-Material-Product-Template-Mapping](../decisions/ADR-016-Item-Material-Product-Template-Mapping.md)): Material is a Custom PrintOS master linked to native Item; Substrate is a specialization of Material (its own ERPNext DocType structure remains deferred to downstream design); Product Template is its own Custom PrintOS artifact, independent of Material and Item. **This layer remains Excluded from the Frozen baseline** — it may now be considered for inclusion in a future Frozen baseline revision, but it is **not automatically promoted by this correction alone.** Resolving AR-006 satisfies its own decision gate only: it does not constitute Blueprint 17's own review completion, does not grant implementation authorization, does not authorize runtime validation, and does not complete any milestone. DocType-level design, field schema, and separate scoped implementation authorization remain separately required before this layer can be newly frozen.
...
| AR-004 | Machine Domain Ownership | Resolved | High | No | Resolved — Machine and Machine Profile Custom (Option C, 2026-09-20) | Machine, Machine Profile, Machine Scheduling; Tier B Job Card | Satisfied | Machine ownership no longer required before finalizing; Machine Scheduling module design remains separately required. Tier B's formerly remaining AR-006 requirement is now also Resolved. | No longer blocks Machine/Machine Profile; Machine Scheduling module design and implementation authorization remain separately required |
| AR-005 | Quotation Strategy | Resolved | High | No | Resolved — Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff (Option B, 2026-09-26) | Estimation/Quotation; Estimation-Sales boundary | Satisfied | Quotation strategy no longer required before finalizing; Quotation Line target and Cost Estimate cost-breakdown design (AR-010) remain separately required | No longer blocks Estimation/Quotation; AR-010 remains separately required |
| AR-006 | Item vs. Material/Product Template Mapping | Resolved | High | No | Resolved — Material is a Custom PrintOS master linked to native Item; Substrate is a specialization of Material; Product Template is its own Custom PrintOS artifact, independent of Material and Item (Option C, 2026-09-26; ADR-016) | Inventory, Estimation, Purchasing master data | Satisfied | Master-data ownership no longer required before finalizing; Substrate's exact DocType structure remains separately required | No longer blocks affected modules; Substrate's downstream DocType-design task and separate scoped implementation authorization remain separately required |
...
| AR-010 | BOM Necessity for Estimation | Open | Medium | Partial | Estimation Engine final-design dependency | Estimation Engine internals | Resolve or formally defer | Not required for structure | AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework |
...
- Machine Scheduling / operational (Tier B) Job Card ownership design — AR-004 is Resolved (Option C, 2026-09-20: Machine and Machine Profile are wholly Custom PrintOS DocTypes), but finalization of Machine Scheduling's own design and operational (Tier B) Job Card completion still await Blueprint review of `16_Print_Machine_Model.md`, DocType-level design, and separate scoped implementation authorization; Job Cards Tier B's formerly remaining AR-006 (Material) gate is now also Resolved;
- Estimation / Quotation implementation design — AR-005 is Resolved (Option B, 2026-09-26: Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff), but finalization of Quotation Line's exact target and Cost Estimate's detailed cost-breakdown design still awaits Blueprint review of `14_Quotation_Engine.md`, downstream DocType-level design, resolution of the coupled AR-010 dependency (AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework), and separate scoped implementation authorization;
- Material / Product Template implementation design — AR-006 is Resolved (Option C, 2026-09-26: Material is a Custom PrintOS master linked to native Item; Substrate is a specialization of Material; Product Template is its own Custom PrintOS artifact, independent of Material and Item; ADR-016), but finalization of Substrate's exact DocType structure still awaits Blueprint review of `17_Inventory_Model.md`, downstream design, and separate scoped implementation authorization;
...
- AR-004 formally dispositioned — **satisfied** (Resolved, Option C, 2026-09-20); Machine Scheduling module design remains separately required before this layer itself can be newly frozen. Job Cards Tier B's formerly remaining AR-006 gate is now also satisfied.
- AR-005 formally dispositioned — **satisfied** (Resolved, Option B, 2026-09-26); Quotation Line's exact target, Cost Estimate's detailed cost-breakdown design, Blueprint 14's own review, and resolution of the coupled AR-010 dependency remain separately required before this layer itself can be newly frozen.
- AR-006 formally dispositioned — **satisfied** (Resolved, Option C, 2026-09-26; ADR-016); Substrate's exact DocType structure, Blueprint 17's own review, and a separate scoped implementation-authorization decision remain separately required before this layer itself can be newly frozen.
...
| 1.6 | 2026-09-26 | AR-006 Disposition Factual Synchronization | Project Owner-approved bounded current-state synchronization of this Approval-stage document with the formal disposition of AR-006 (Option C, recorded in `Architecture_Review_Register.md`, Version 0.8; [ADR-016-Item-Material-Product-Template-Mapping](../decisions/ADR-016-Item-Material-Product-Template-Mapping.md)): Material is a Custom PrintOS master record linked to native Item; Substrate is a specialization of Material; Product Template is its own Custom PrintOS artifact, independent of Material and Item. Updated the AR-006 table row's Register Status/Blocks Development columns (reproduced verbatim from the Register) from Open/Partial to Resolved/No, Priority unchanged at High; corrected AR-004's own row to remove its now-satisfied reference to Job Cards Tier B's formerly remaining AR-006 gate. Recorded the ownership boundary per `../blueprint/17_Inventory_Model.md`, Version 0.1 (an existing, previously empty Placeholder — no new file created). Added a Section 4 diagram Note recording AR-006's Resolution, matching the AR-001/AR-002/AR-004/AR-005 note precedent, explicitly stating this resolution satisfies AR-006's own decision gate only and does not promote frozen scope, authorize implementation, authorize runtime validation, or complete any milestone. Corrected Section 10.5 (Material and Product Template ownership) with the same explicit gate-only framing, the Group A table row for `../blueprint/08_Master_Data_Model.md` (recording its own bounded Version 1.1 correction without reopening its Frozen classification), the Conditional References rows for `ERPNext_DocType_Mapping.md` and `ERPNext_Gap_Analysis.md`, Section 18.2's roadmap-readiness item, and Section 21's exit criterion. A **separate, bounded correction to `../blueprint/08_Master_Data_Model.md` itself** (Version 1.0 → 1.1) was authorized by the Project Owner without a fresh Architecture or Business Review; a Consistency Review and Documentation Governance check were performed and confirmed this correction does not reopen that document's Frozen classification under this document's Section 8 (Group A) and does not contradict any other current-state citation here. This is not a repeated or new Architecture Review or Business Review of this document itself; the Section 22 Validation Checklist and original Project Owner Approval record are preserved unchanged as historical record. No frozen scope, Excluded-layer classification, or Full-Freeze exit criterion changed beyond formally satisfying AR-006's own exit criterion; Substrate's exact DocType structure, Blueprint 17's own review, and a separate scoped implementation-authorization decision remain separately required. This document's own Status remains **Approval**; no implementation, runtime validation, Publication, or milestone completion is authorized or claimed. AR-001 through AR-005 remain Resolved as previously recorded; AR-007 through AR-011 unchanged. The unrelated stale conditional-reference row for `Module_Dependency_Matrix.md` (Section 9) was **not** corrected by this synchronization and remains a separate, independent documentation-hygiene task. |
| 1.5 | 2026-09-26 | AR-005 Disposition Factual Synchronization | Project Owner-approved bounded current-state synchronization of this Approval-stage document with the formal disposition of AR-005 (Option B, recorded in `Architecture_Review_Register.md`, Version 0.7): Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff. Updated the AR-005 table row's Register Status/Blocks Development columns (reproduced verbatim from the Register) from Open/Partial to Resolved/No, Priority unchanged at High. Recorded that native Quotation remains the customer-facing document, per `../blueprint/14_Quotation_Engine.md`, Version 0.1 (an existing, previously empty Placeholder — no new file created). Added a Section 4 diagram Note recording AR-005's Resolution, matching the AR-001/AR-002/AR-004 note precedent. Corrected Section 10.4 (Quotation strategy), the Conditional References rows for `ERPNext_DocType_Mapping.md` and `ERPNext_Gap_Analysis.md`, the AR-010 table row's Notes column, Section 18.2's roadmap-readiness item, and Section 21's exit criterion — each using the normalized wording: AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework. This is not a repeated or new Architecture Review or Business Review of this document; a bounded Consistency Review and Documentation Governance check were applied, confirming the correction does not reopen the Frozen baseline or contradict any other current-state citation. The Section 22 Validation Checklist and original Project Owner Approval record are preserved unchanged as historical record. No frozen scope, Excluded-layer classification, or Full-Freeze exit criterion changed beyond formally satisfying AR-005's own exit criterion; Quotation Line's exact target, Cost Estimate's detailed cost-breakdown design, Blueprint 14's own review, and resolution of the coupled AR-010 dependency remain separately required. This document's own Status remains **Approval**; no implementation authorized. AR-001 through AR-004 remain Resolved as previously recorded; AR-006 through AR-011 unchanged. |
