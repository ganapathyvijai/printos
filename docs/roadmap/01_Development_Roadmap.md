...
- **Job Card Tier B (the operationally schedulable Job Card) is the principal convergence point** of the dependency graph; it now has no remaining Architecture Review convergent blocker (AR-004's Machine-Scheduling consequence Resolved, 2026-09-20; AR-005's Quotation-strategy consequence Resolved, 2026-09-26; AR-006's Material consequence Resolved, 2026-09-26) (Matrix §8; Section 15).
...
| AR-004 | Machine Domain Ownership | Resolved | High | No | Machine Scheduling (formerly direct); Job Cards Tier B (formerly convergent) | Permitted | Permitted | Permitted | Declarable | "Resolved — Option C selected 2026-09-20. Machine is wholly Custom; Machine Profile remains Custom." | No remaining decision. |
| AR-005 | Quotation Strategy | Resolved | High | No | Estimation (formerly direct); Sales, Production Planning, Job Cards (formerly transitive) | Permitted | Permitted | Permitted | Declarable | "Resolved — Option B selected 2026-09-26. Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff; native Quotation remains the customer-facing document." | No remaining decision on document strategy; Quotation Line's exact target and Cost Estimate's cost-breakdown design remain deferred to downstream DocType design, and AR-010 remains open. |
| AR-006 | Item vs. Material/Product Template Mapping | Resolved | High | No | Inventory, Estimation (formerly direct); Purchasing (formerly transitive); Job Cards (formerly convergent) | Permitted | Permitted | Permitted | Declarable | "Resolved — Option C selected 2026-09-26 (ADR-016). Material is a Custom PrintOS master linked to native Item; Substrate is a specialization of Material; Product Template is its own Custom PrintOS artifact, independent of Material and Item." | No remaining decision on ownership boundary; Substrate's exact DocType structure remains deferred to downstream design |
...
| AR-010 | BOM Necessity for Estimation | Open | Medium | Partial | Estimation Engine internals | Permitted | Not permitted (engine internals) | Not required for structure | Delays final Estimation design | "BOM necessity unconfirmed" | Whether BOM is adopted for Estimation costing. AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework. |
...
| Estimation | Estimation | Conditional Roadmap Scope | Architecture Review Blocked | AR-010 (AR-005 Resolved, Option B, 2026-09-26; AR-006 Resolved, Option C, 2026-09-26); AR-001 resolved, v16 technical revalidation pending | Define Conditional Workstream | Architecture Review Blocked | Not Authorized | "Key differentiator"; Product Template (AR-006) is now Resolved and no longer a direct block; Quotation document strategy is settled but Quotation Line's exact target and Cost Estimate's cost-breakdown design remain deferred pending AR-010 |
| Sales | Core Business Operations | Conditional Roadmap Scope | Conditional Architecture | AR-001 resolved, v16 technical revalidation pending; Estimation's remaining AR-010 exposure (AR-005 Resolved, Option B, 2026-09-26, and AR-006 Resolved, Option C, 2026-09-26, no longer sources of transitive delay) | Define Conditional Workstream | Conditional | Not Authorized | Reorder path independent of Estimation standard path |
...
| Inventory | Core Business Operations | Conditional Roadmap Scope | Architecture Resolved | None — AR-006 Resolved (Option C, 2026-09-26; ADR-016); AR-001 resolved, v16 technical revalidation pending | Define Conditional Workstream | Conceptually Ready | Not Authorized | Material/Substrate ownership settled; Substrate's exact DocType structure and implementation authorization remain separately required |
| Purchasing / Procurement | Core Business Operations | Conditional Roadmap Scope | Conditional Architecture | AR-007 (naming); AR-001 resolved, v16 technical revalidation pending. Former AR-006 (transitive) exposure is Resolved. | Define Conditional Workstream | Conditional | Not Authorized | Core PO/Supplier stable; replenishment logic no longer delayed by AR-006; both names retained |
| Production Planning | Production Operations | Conditional Roadmap Scope | Conditional Architecture | AR-004 exposure Resolved; AR-005 exposure Resolved, Option B, 2026-09-26; AR-006 exposure Resolved, Option C, 2026-09-26 (transitive/convergent via inputs, formerly) | Define Conditional Workstream | Conditional | Not Authorized | Distinct module (ADR-014); consumes, does not create Job Card |
| Job Cards | Production Operations | Conditional Roadmap Scope (Tier A / Tier B gates) | Conditional Architecture | AR-009; AR-004 convergent exposure Resolved; AR-005 transitive exposure Resolved (Option B, 2026-09-26); AR-006 convergent exposure Resolved (Option C, 2026-09-26) — Tier B now has no remaining Architecture Review convergent blocker | Define Conditional Workstream | Conceptually Ready (Tier A) / Conditional (Tier B) | Not Authorized | One aggregate, one DocType; tiers are readiness gates |
| Machine Scheduling | Production Operations | Conditional Roadmap Scope | Architecture Resolved | None — AR-004 Resolved (Option C, 2026-09-20) | Define Conditional Workstream | Conceptually Ready | Not Authorized | Machine / Machine Profile ownership settled; module design and implementation authorization remain separately required |
...
| MachineIQ | Deferred Product Capabilities | Later-Phase Deferral | Later-Phase Unscoped | ADR-008 scope deferred (AR-004 indirect exposure Resolved) | Defer | Deferred | Not Authorized | Platform ships completely without it |
...
- **Conditional content:** Quotation Line's exact target; Estimation Engine internal cost-breakdown approach. Quotation's own document strategy is Resolved (AR-005, Option B, 2026-09-26): Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff. Product Template ownership is Resolved (AR-006, Option C, 2026-09-26; ADR-016): its own Custom PrintOS artifact, independent of Material and Item.
- **Direct AR gates:** None remaining — AR-005 (Quotation strategy) and AR-006 (Material/Product Template) are both Resolved and no longer direct gates.
- **Transitive/convergent gates:** AR-010 (BOM necessity — Engine internals; also gates Quotation Line's exact target and Cost Estimate's cost-breakdown design — AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework); AR-001 (cross-cutting) — Resolved; technical revalidation pending.
- **Permitted Working Assumptions:** Estimation → Sales boundary as frozen. ERPNext v16 is no longer an assumption — it is the AR-001-governed target (reaffirming Accepted ADR-001); capability-level Estimation claims remain conditional pending technical revalidation. Quotation's document strategy (Option B) and Product Template's ownership (Option C) are likewise no longer assumptions — they are the AR-005- and AR-006-governed dispositions.
- **Prohibited finalization:** Quotation Line's exact target and downstream handoff mechanics; Substrate's exact DocType structure; whether BOM is adopted.
- **Traceability:** `blueprint/05_Domain_Model.md`; `blueprint/06_Bounded_Contexts.md`; `blueprint/14_Quotation_Engine.md`; `blueprint/17_Inventory_Model.md`; AR-005 (Resolved)/006 (Resolved)/010; ADR-013; ADR-016; `ERPNext_DocType_Mapping.md` (Pending rows); Matrix §7.
- **Implementation authorization:** Not Authorized.
...
- **Conditional content:** standard-path completion transitively delayed via Estimation's remaining AR-010 exposure and the Job Cards convergence (Estimation's AR-005 Quotation-strategy and AR-006 Material/Product Template exposures are both Resolved, 2026-09-26, and no longer sources of delay).
- **Direct AR gates:** none of their own. **Transitive:** Estimation's remaining AR-010 exposure (Sales/Artwork standard path); via Job Cards for Dispatch. **Naming:** AR-008 (Dispatch/Delivery, non-blocking).
...
- **Prohibited finalization:** anything dependent on the unresolved Job Card convergence for the standard path.
- **Traceability:** `blueprint/06_Bounded_Contexts.md`; `blueprint/10_Business_Workflows.md`; AR-005 (Resolved)/006 (Resolved)/008; Matrix §7, §9.
- **Implementation authorization:** Not Authorized.
...
- **Conditional content:** Substrate's exact DocType structure (Inventory, deferred to downstream design); replenishment-trigger logic (Purchasing). Material/Substrate ownership itself is Resolved (AR-006, Option C, 2026-09-26; ADR-016).
- **Direct AR gates:** None remaining — AR-006 (Inventory, Material/Substrate) is Resolved and no longer a direct or transitive gate for either module. **Naming:** AR-007 (Purchasing/Procurement, non-blocking).
- **Permitted Working Assumptions:** native PO/Supplier as classified (pending technical revalidation). ERPNext v16 is no longer an assumption — it is the AR-001-governed target (reaffirming Accepted ADR-001). Material/Substrate's ownership boundary (Option C) is likewise no longer an assumption — it is the AR-006-governed disposition.
- **Prohibited finalization:** Substrate's exact DocType structure (child table vs. standalone); the canonical Purchasing/Procurement term.
- **Traceability:** `blueprint/08_Master_Data_Model.md`; `blueprint/17_Inventory_Model.md`; AR-006 (Resolved)/007; ADR-016; `ERPNext_DocType_Mapping.md`; Matrix §7, §14.
- **Implementation authorization:** Not Authorized.
...
- **Direct AR gates:** none — AR-004 (Machine Scheduling — Machine/Machine Profile) is Resolved (Option C, 2026-09-20).
- **Convergent gates:** none remaining on Job Cards Tier B — AR-004's convergent contribution is Resolved, and AR-006's convergent contribution (Material) is also Resolved (Option C, 2026-09-26; ADR-016).
- **Transitive gates:** AR-009 (Quality Check Record, non-blocking). AR-005 exposure via the Sales Order standard path is Resolved (Option B, 2026-09-26) and no longer a source of delay.
- **Prohibited finalization:** operational (Tier B) Job Card design. Machine ownership design and the former AR-006 convergent input are no longer prohibited at the category level (both Resolved), but DocType-level design and implementation remain separately unauthorized pending Blueprint 16/17 review and scoped implementation authorization.
- **Implementation authorization:** Not Authorized.
...
- Remains **Conditional** — but now has **no remaining Architecture Review convergent blocker**: AR-004's Machine/Machine Scheduling contribution is Resolved (Option C, 2026-09-20), AR-005's Quotation, transitive via Sales Order, contribution is Resolved (Option B, 2026-09-26), and AR-006's Material, via allocation, contribution is Resolved (Option C, 2026-09-26; ADR-016). Material allocation's own engineering/implementation work and Machine Scheduling's own engineering completion remain structural prerequisites, distinct from Architecture Review exposure. This is **convergent blocking**, not direct blocking of the Job Card entity.
...
**Traceability:** ADR-014; `blueprint/09_PrintOS_Modules.md`; `Canonical_Domain_Model.md`; `ERPNext_DocType_Mapping.md` (single Job Card row); AR-004 (Resolved)/005 (Resolved)/006 (Resolved)/009; Matrix §6–9.
...
- **Direct blocking** — Estimation, Inventory, Configuration Studio Tenant Override, AI Assistant. (Machine Scheduling is no longer directly blocked — AR-004 Resolved, Option C, 2026-09-20.)
...
- Machine ownership (AR-004 is Resolved — Option C, 2026-09-20: Machine and Machine Profile are wholly Custom PrintOS DocTypes; Blueprint review of `16_Print_Machine_Model.md` and separate scoped implementation authorization remain outside this synchronization);
- Quotation strategy (AR-005 is Resolved — Option B, 2026-09-26: Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff; Blueprint review of `14_Quotation_Engine.md`, Quotation Line's exact target, Cost Estimate's cost-breakdown design, and separate scoped implementation authorization remain outside this synchronization);
- Material/Product Template ownership (AR-006 is Resolved — Option C, 2026-09-26: Material is a Custom PrintOS master linked to native Item; Substrate is a specialization of Material; Product Template is its own Custom PrintOS artifact, independent of Material and Item; Blueprint review of `17_Inventory_Model.md`, Substrate's exact DocType structure, and separate scoped implementation authorization remain outside this synchronization);
- BOM decision (AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework);
...
- **AR-007 through AR-011** — all Open (Section 10; register verbatim). **AR-001** — Resolved (Option A; ERPNext v16/Frappe v16 governed target, reaffirming Accepted ADR-001); capability-level technical revalidation remains outstanding and is outside this roadmap's scope. **AR-002** — Resolved (Option A; one isolated Frappe site and operational database per Tenant, Tenant distinct from Company, per Accepted ADR-015, Version 1.0); implementation design, Publication of `25_MultiTenant_Architecture.md`, and separate scoped authorization remain outstanding and are outside this roadmap's scope. **AR-003** — Resolved (Option A, 2026-09-19; seven terms mapped/confirmed/rejected against existing Approved concepts, AI Assistant registered as Proposed only); AI Assistant's architecture, Bounded Context, provider, and model remain outstanding, pending separate future governance, and are outside this roadmap's scope. **AR-004** — Resolved (Option C, 2026-09-20; Machine and Machine Profile are wholly Custom PrintOS DocTypes, per `16_Print_Machine_Model.md`); Blueprint review completion and a separate scoped implementation-authorization decision remain outstanding and are outside this roadmap's scope. **AR-005** — Resolved (Option B, 2026-09-26; Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff, per `14_Quotation_Engine.md`); Quotation Line's exact target, Cost Estimate's detailed cost-breakdown design, Blueprint review completion, resolution of the coupled AR-010 dependency, and a separate scoped implementation-authorization decision remain outstanding and are outside this roadmap's scope. **AR-006** — Resolved (Option C, 2026-09-26; Material is a Custom PrintOS master linked to native Item, Substrate is a specialization of Material, Product Template is its own Custom PrintOS artifact independent of Material and Item, per `17_Inventory_Model.md` and ADR-016); Substrate's exact DocType structure, Blueprint review completion, and a separate scoped implementation-authorization decision remain outstanding and are outside this roadmap's scope. AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework.
...
**Subsequent current-state synchronization (2026-09-20) — Project Owner Synchronization Note (AR-004 Disposition):**

- **Approval type:** Factual baseline synchronization.
- **Authority:** Project Owner.
- **Synchronization approved:** 2026-09-20.
- **Approved transition:** Development Roadmap Approval Version 1.3 → Approval Version 1.4, recording the formally completed AR-004 disposition (Option C: Machine is a wholly Custom PrintOS DocType inside `printos_core`; Machine Profile remains Custom), per `../blueprint/16_Print_Machine_Model.md`, Version 0.1 (an existing, previously empty Placeholder — no new file created), and `../decisions/Architecture_Review_Register.md`, Version 0.6.
- The historical Architecture Review, Business Review, and Project Owner Approval record above — including the 2026-07-26 approval date and its statement that "AR-003 through AR-011 remain Open and unresolved" at the time of that approval, and the 2026-09-19 AR-003 Synchronization Note's statement that "AR-004 through AR-011 remain Open and unchanged" at the time of that synchronization — remains **unchanged**, exactly as originally recorded.
- **AR-005 through AR-011 remain Open and unchanged.**
- No Architecture Review or Business Review was repeated for this synchronization, because no roadmap scope, dependency direction, workstream taxonomy, or business content changed — only AR-004's official-field status and derived interpretive wording were reconciled with its resolved disposition. As a direct, derived consequence of AR-004's Resolved status, Machine Scheduling's Architecture Readiness (Section 12, Scope Matrix) was updated from "Architecture Review Blocked" to "Architecture Resolved," and its Current Readiness was updated from "Architecture Review Blocked" to "Conceptually Ready"; no other workstream's readiness classification was changed.
- No implementation authorization was granted by this synchronization; every workstream remains Not Authorized; Full Architecture Freeze remains unachieved.

**Subsequent current-state synchronization (2026-09-26) — Project Owner Synchronization Note (AR-005 Disposition):**

- **Approval type:** Factual baseline synchronization.
- **Authority:** Project Owner.
- **Synchronization approved:** 2026-09-26.
- **Approved transition:** Development Roadmap Approval Version 1.4 → Approval Version 1.5, recording the formally completed AR-005 disposition (Option B: Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff; native Quotation remains the customer-facing document), per `../blueprint/14_Quotation_Engine.md`, Version 0.1 (an existing, previously empty Placeholder — no new file created), and `../decisions/Architecture_Review_Register.md`, Version 0.7.
- The historical Architecture Review, Business Review, and Project Owner Approval record above — including the 2026-07-26 approval date and its statement that "AR-003 through AR-011 remain Open and unresolved" at the time of that approval, the 2026-09-19 AR-003 Synchronization Note's statement that "AR-004 through AR-011 remain Open and unchanged" at the time of that synchronization, and the 2026-09-20 AR-004 Synchronization Note's statement that "AR-005 through AR-011 remain Open and unchanged" at the time of that synchronization — remains **unchanged**, exactly as originally recorded.
- **AR-006 through AR-011 remain Open and unchanged.** AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework; it is not a condition on AR-005's own disposition and is not treated as resolved, mandatory, or a new module-level blocker by this synchronization.
- No Architecture Review or Business Review was repeated for this synchronization, because no roadmap scope, dependency direction, workstream taxonomy, or business content changed — only AR-005's official-field status and derived interpretive wording were reconciled with its resolved disposition. No workstream's readiness classification changed beyond removing AR-005 as a direct or transitive gate; Quotation Line's exact target and Cost Estimate's detailed cost-breakdown design remain deferred to a separate downstream DocType-design task.
- No implementation authorization was granted by this synchronization; every workstream remains Not Authorized; Full Architecture Freeze remains unachieved.

**Subsequent current-state synchronization (2026-09-26) — Project Owner Synchronization Note (AR-006 Disposition):**

- **Approval type:** Factual baseline synchronization.
- **Authority:** Project Owner.
- **Synchronization approved:** 2026-09-26.
- **Approved transition:** Development Roadmap Approval Version 1.5 → Approval Version 1.6, recording the formally completed AR-006 disposition (Option C: Material is a Custom PrintOS master record linked to native Item; Substrate is a specialization of Material, with its exact DocType structure deferred to downstream design; Product Template is its own Custom PrintOS artifact, independent of Material and Item), formalized in `../decisions/ADR-016-Item-Material-Product-Template-Mapping.md` (Accepted, Version 1.0), per `../blueprint/17_Inventory_Model.md`, Version 0.1 (an existing, previously empty Placeholder — no new file created), and `../decisions/Architecture_Review_Register.md`, Version 0.8.
- The historical Architecture Review, Business Review, and Project Owner Approval record above — including the 2026-07-26 approval date and its statement that "AR-003 through AR-011 remain Open and unresolved" at the time of that approval, the 2026-09-19 AR-003 Synchronization Note's statement that "AR-004 through AR-011 remain Open and unchanged," the 2026-09-20 AR-004 Synchronization Note's statement that "AR-005 through AR-011 remain Open and unchanged," and the 2026-09-26 AR-005 Synchronization Note's statement that "AR-006 through AR-011 remain Open and unchanged" — remains **unchanged**, exactly as originally recorded.
- **AR-007 through AR-011 remain Open and unchanged.** AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework; it is not a condition on AR-006's own disposition and is not treated as resolved, mandatory, or a new module-level blocker by this synchronization.
- No Architecture Review or Business Review was repeated for this synchronization, because no roadmap scope, dependency direction, workstream taxonomy, or business content changed — only AR-006's official-field status and derived interpretive wording were reconciled with its resolved disposition. Job Cards Tier B's convergent-blocking classification (Section 12, Scope Matrix) is unchanged as "Conditional" — it now has no remaining Architecture Review convergent blocker, but Machine Scheduling's and Material allocation's own engineering completion remain separate structural prerequisites. Inventory's Architecture Readiness was updated from "Architecture Review Blocked" to "Architecture Resolved," and its Current Readiness from "Architecture Review Blocked" to "Conceptually Ready," mirroring the precedent established for Machine Scheduling upon AR-004's Resolution; no other workstream's readiness classification was changed. Substrate's exact DocType structure remains deferred to a separate downstream DocType-design task.
- A bounded correction to `../blueprint/08_Master_Data_Model.md` (Version 1.0 → 1.1), resolving its own Substrate-specialization Open Question, was authorized by the Project Owner without a fresh Architecture or Business Review of that document; this roadmap synchronization does not itself perform or claim that correction, which is recorded in `08_Master_Data_Model.md`'s own Revision History.
- No implementation authorization was granted by this synchronization; every workstream remains Not Authorized; Full Architecture Freeze remains unachieved. The unrelated stale conditional-reference correction to `Architecture_Freeze.md` (Section 9) was **not** performed by this synchronization and remains a separate, independent documentation-hygiene task.
...
| 1.6 | 2026-09-26 | Project Owner-Approved AR-006 Factual Synchronization | Project Owner-approved bounded current-state synchronization of this Approval-stage document following the formal Project Owner disposition of AR-006 (Option C, recorded in `Architecture_Review_Register.md`, Version 0.8; formalized in `ADR-016-Item-Material-Product-Template-Mapping.md`): Material is a Custom PrintOS master record linked to native Item; Substrate is a specialization of Material, with its exact DocType structure deferred to downstream design; Product Template is its own Custom PrintOS artifact, independent of Material and Item. Updated AR-006's official-field reproduction in Section 10 from Open/High/Partial to Resolved/High/No, and its interpretive columns to record the Resolved disposition. Corrected the active Open Governance Items statement (Section 24) from "AR-006 through AR-011 — all Open" to "AR-007 through AR-011," reflecting AR-006's new Resolved status, with a new sentence appended describing the disposition. Corrected the Scope Matrix rows (Section 12) for Estimation, Sales, Inventory, Purchasing/Procurement, Production Planning, and Job Cards — Inventory's Architecture Readiness moved from "Architecture Review Blocked" to "Architecture Resolved" and its Current Readiness from "Architecture Review Blocked" to "Conceptually Ready," mirroring the AR-004/Machine Scheduling precedent; Sections 14.1, 14.4, and 14.5's Direct/Convergent/Transitive AR gates and Traceability citations; the Job Card Tier B convergence sentence (Section 15) and its Traceability citation; the "does not authorize" list item (Section 23); and the Section 3 convergence-point summary. Added a new, separately dated Project Owner Synchronization Note within Section 25 (approval date 2026-09-26), appended after the AR-005 note, explicitly preserving the entire dated 2026-07-26 Architecture Review, Business Review, and Project Owner Approval record, the 2026-09-19 AR-003 Synchronization Note, the 2026-09-20 AR-004 Synchronization Note, and the 2026-09-26 AR-005 Synchronization Note — including their respective historical "remain Open" statements — verbatim and unchanged. A bounded Consistency Review and Documentation Governance check were applied, confirming this correction does not reopen roadmap scope and does not contradict any other current-state citation. No roadmap scope, workstream taxonomy, dependency direction, sequencing, or readiness classification changed beyond recording AR-006 as Resolved and removing it as a direct/transitive/convergent gate; Substrate's exact DocType structure remains deferred to downstream design, and AR-010 remains separately open, not treated as resolved, mandatory, or a new module-level blocker. No Architecture or Business Review was repeated for this document. A separate, bounded correction to `../blueprint/08_Master_Data_Model.md` (Version 1.0 → 1.1) was authorized by the Project Owner without a fresh Architecture or Business Review of that document, resolving its own Substrate-specialization Open Question; this synchronization does not itself perform that correction. This document's own Status remains **Approval**. AR-001 through AR-005 remain Resolved as previously recorded; AR-007 through AR-011 remained unchanged and Open. No implementation, runtime validation, Publication, or milestone completion authorized. The unrelated stale conditional-reference row in `Architecture_Freeze.md` (Section 9) was **not** corrected by this synchronization and remains a separate, independent documentation-hygiene task. |
| 1.5 | 2026-09-26 | Project Owner-Approved AR-005 Factual Synchronization | Project Owner-approved bounded current-state synchronization of this Approval-stage document following the formal Project Owner disposition of AR-005 (Option B, recorded in `Architecture_Review_Register.md`, Version 0.7): Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff. Updated AR-005's official-field reproduction in Section 10 from Open/High/Partial to Resolved/High/No, and its interpretive columns to record the Resolved disposition, using the normalized wording: AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework. Corrected the active Open Governance Items statement (Section 24) from "AR-005 through AR-011 — all Open" to "AR-006 through AR-011," reflecting AR-005's new Resolved status, with a new sentence appended describing the disposition. Corrected the Scope Matrix rows (Section 12) for Estimation, Sales, Production Planning, and Job Cards; Sections 14.1, 14.3, and 14.5's Direct/Transitive AR gates and Traceability citations; the Job Card Tier B convergence sentence (Section 15) and its Traceability citation; the "does not authorize" list item (Section 23); and the Section 3 convergence-point summary. Added a new, separately dated Project Owner Synchronization Note within Section 25 (approval date 2026-09-26), appended after the AR-004 note, explicitly preserving the entire dated 2026-07-26 Architecture Review, Business Review, and Project Owner Approval record, the 2026-09-19 AR-003 Synchronization Note, and the 2026-09-20 AR-004 Synchronization Note — including their respective historical "remain Open" statements — verbatim and unchanged. A bounded Consistency Review and Documentation Governance check were applied, confirming this correction does not reopen roadmap scope and does not contradict any other current-state citation. No roadmap scope, workstream taxonomy, dependency direction, sequencing, or readiness classification changed beyond recording AR-005 as Resolved and removing it as a direct/transitive gate; Quotation Line's exact target and Cost Estimate's detailed cost-breakdown design remain deferred to downstream DocType design, and AR-010 remains separately open, not treated as resolved, mandatory, or a new module-level blocker. No Architecture or Business Review was repeated. This document's own Status remains **Approval**. AR-001 through AR-004 remain Resolved as previously recorded; AR-006 through AR-011 remained unchanged and Open. No implementation authorized. |
| 1.4 | 2026-09-20 | Project Owner-Approved AR-004 Factual Synchronization | Project Owner-approved bounded current-state synchronization of this Approval-stage document following the formal Project Owner disposition of AR-004 (Option C, recorded in `Architecture_Review_Register.md`, Version 0.6). Updated AR-004's official-field reproduction in Section 10 from Open/High/Partial to Resolved/High/No, and its interpretive columns to record Machine and Machine Profile as Resolved (Custom). Corrected the active Open Governance Items statement (Section 24) from "AR-004 through AR-011 — all Open" to "AR-005 through AR-011," reflecting AR-004's new Resolved status, with a new sentence appended describing the disposition. Corrected the Scope Matrix rows (Section 12) for Production Planning, Job Cards, and Machine Scheduling; the Direct blocking list; the "does not authorize" list item; Section 14.5's Direct/Convergent AR gates and Prohibited finalization; the Job Card Tier B convergence sentence (Section 15); and the Traceability citation. Added a new, separately dated Project Owner Synchronization Note within Section 25 (approval date 2026-09-20), explicitly preserving the entire dated 2026-07-26 Architecture Review, Business Review, and Project Owner Approval record and the 2026-09-19 AR-003 Synchronization Note — including their respective historical "AR-003 through AR-011 remain Open and unresolved" and "AR-004 through AR-011 remain Open and unchanged" statements — verbatim and unchanged. A bounded Consistency Review and Documentation Governance check were applied, confirming this correction does not reopen roadmap scope and does not contradict any other current-state citation. No roadmap scope, workstream taxonomy, dependency direction, sequencing, or readiness classification changed beyond recording AR-004 as Resolved. No Architecture or Business Review was repeated. This document's own Status remains **Approval**. AR-001 through AR-003 remain Resolved as previously recorded; AR-005 through AR-011 remained unchanged and Open. No implementation authorized. |
