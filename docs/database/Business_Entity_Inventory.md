...
- **Architecture Notes:** Resolved — own Custom PrintOS artifact, independent of Material and Item (AR-006, Option C, 2026-09-26; [ADR-016-Item-Material-Product-Template-Mapping](../decisions/ADR-016-Item-Material-Product-Template-Mapping.md)).
...
- **Architecture Notes:** Resolved — Custom PrintOS master linked to native Item (AR-006, Option C, 2026-09-26; [ADR-016-Item-Material-Product-Template-Mapping](../decisions/ADR-016-Item-Material-Product-Template-Mapping.md)).
...
- **Architecture Notes:** Substrate is a specialization of Material (AR-006, Option C, 2026-09-26; [ADR-016-Item-Material-Product-Template-Mapping](../decisions/ADR-016-Item-Material-Product-Template-Mapping.md)); its exact ERPNext DocType structure (child table vs. standalone) is deferred to downstream design.
...
- **Architecture Notes:** Resolved — Machine is a wholly Custom DocType per [Architecture_Review_Register.md](../decisions/Architecture_Review_Register.md) AR-004, Option C (2026-09-20); see [16_Print_Machine_Model.md](../blueprint/16_Print_Machine_Model.md).
...
- **Architecture Notes:** Resolved — see AR-004, Option C (2026-09-20).
...
- **Architecture Notes:** Canonical per [ADR-013-Quotation-Terminology](../decisions/ADR-013-Quotation-Terminology.md). Document strategy Resolved — [Architecture_Review_Register.md](../decisions/Architecture_Review_Register.md) AR-005, Option B (2026-09-26): Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff; see [14_Quotation_Engine.md](../blueprint/14_Quotation_Engine.md). AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework — not resolved here.
...
- **Note:** This record is **not a Job Card-owned entity**; the Job Card consumes only the Approved Production Artwork Set (Section — see `database/Artwork_Authority_DocType_Specification.md` Section 7.1). Its final technical name remains pending naming governance under Naming Registry §§5, 26, 38 and 39 (a separate, currently untracked question — **not** governed by `AR-003`, whose own recorded scope is unrelated), which is **not** resolved or established here.
...
- ✓ **Architecture Review items are referenced where applicable.** AR-002 (Company), AR-003 (Resolved 2026-09-19 — cited for "Print Specification," Not Adopted, and "AI Assistant," Proposed name only; Approval Record and the five AI candidate entities are correctly noted as outside AR-003's scope, not governed by it), AR-004 (Machine, Machine Profile — Resolved, Option C, 2026-09-20), AR-005 (Quotation — Resolved, Option B, 2026-09-26; AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework), AR-006 (Material, Substrate, Product Template — Resolved, Option C, 2026-09-26; ADR-016), AR-008 (Dispatch Record), AR-009 (Quality Check Record), AR-011 (Lead/Enquiry) are each cited in their corresponding entity's Architecture Notes.
...
| 0.7 | 2026-09-26 | AR-006 Disposition Synchronization | Corrected active statements following [Architecture_Review_Register.md](../decisions/Architecture_Review_Register.md) AR-006's Resolved disposition (Option C, 2026-09-26; [ADR-016-Item-Material-Product-Template-Mapping](../decisions/ADR-016-Item-Material-Product-Template-Mapping.md)). **Product Template:** Architecture Notes corrected from "Pending ADR (§27 item 10)" framing to Resolved — its own Custom PrintOS artifact, independent of Material and Item, citing the now-populated [17_Inventory_Model.md](../blueprint/17_Inventory_Model.md), Version 0.1. **Material:** Architecture Notes corrected to Resolved — Custom PrintOS master linked to native Item. **Substrate:** added a new Architecture Notes line (previously absent) recording that Substrate is a specialization of Material, with its exact DocType structure deferred to downstream design. Updated the Validation section's Architecture Review Register statement to record AR-006 as Resolved and to include Substrate and Product Template alongside Material in its citation. No entity definition, cardinality, relationship, or lifecycle was altered beyond these Architecture Notes corrections; no ERPNext mapping, DocType design, or database schema design performed; no Architecture Review Register item was created or modified beyond AR-006 itself; no implementation was authorized. |
| 0.6 | 2026-09-26 | AR-004 and AR-005 Disposition Synchronization | Corrected active statements following [Architecture_Review_Register.md](../decisions/Architecture_Review_Register.md) AR-004's Resolved disposition (Option C, 2026-09-20) and AR-005's Resolved disposition (Option B, 2026-09-26), neither of which had previously been synchronized into this document. **Machine:** Architecture Notes corrected from "Pending Architecture Review" framing to Resolved — Machine is a wholly Custom DocType per AR-004, Option C, citing the now-populated [16_Print_Machine_Model.md](../blueprint/16_Print_Machine_Model.md), Version 0.1. **Machine Profile:** Architecture Notes corrected to cite AR-004 as Resolved, Option C. **Quotation:** Architecture Notes corrected to record AR-005 Resolved (Option B, 2026-09-26): Custom Cost Estimate and pricing logic feed ERPNext's native Quotation through a governed handoff, citing the now-populated [14_Quotation_Engine.md](../blueprint/14_Quotation_Engine.md), Version 0.1; handoff mechanics, fields, and Quotation Line's exact target remain deferred to a separate downstream DocType-design task. AR-010 remains Open and should be resolved before detailed Cost Estimate cost-breakdown design, to avoid later rework — this is not resolved by AR-005 and is recorded here as a remaining open dependency, not a new condition on AR-005's own disposition. Updated the Validation section's Architecture Review Register statement to record AR-004 and AR-005 as Resolved. No entity definition, cardinality, relationship, or lifecycle was altered beyond these Architecture Notes corrections; no ERPNext mapping, DocType design, or database schema design performed; no Architecture Review Register item was created or modified; neither AR-004 nor AR-005 was further modified by this document; no implementation was authorized. |
