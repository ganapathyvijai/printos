...
| Database | 10 | 00_Master_Index + 01–06 + Business_Entity_Inventory + ERPNext_DocType_Mapping + JobCard_TierA_DocType_Specification (Draft, Version 0.1; not Published; not safe for coding) |
...
| Implementation | 19 | 00_Implementation_Index + 01–08 populated + Module_Dependency_Matrix + Architecture_Freeze + JobCard_TierA_System_Design (Draft, Version 0.1; targets Approval); 09–15 remain empty Placeholder |
