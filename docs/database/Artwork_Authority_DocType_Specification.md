...
- [../implementation/JobCard_TierA_System_Design.md](../implementation/JobCard_TierA_System_Design.md) — the consuming Production design; currently **Approval, Version 1.10** (2026-09-13, promoted in place at the same version number since it remained uncommitted, adopting Rule 11/Section 10.5 and its three-finding correction, with no content change), with **Approval, Version 1.7** (Project Owner Document Lifecycle Approval granted 2026-08-19 at Version 1.5; carried forward through its own bounded reference-only correction and naming-status synchronization, both on 2026-08-22) as the immediately prior approved baseline, and prior historical baselines before that **Approval, Version 1.6**, **Approval, Version 1.5**, and **Approval, Version 1.4**. Its Version 1.5 content records the `production_artwork_set` reference contract, now approved. (`ART-M4-LCV-F2` corrected.)
