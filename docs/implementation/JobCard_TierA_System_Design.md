...
- **Race-safe uniqueness mechanism** — selected and validated (Section 21). **Remains open.**
...
7. P-2 (Closed, 2026-07-30) and other pre-Publication technical closures (Section 25 — race-safe uniqueness, terminal-reason persistence, and the Artwork production gate remain open).
...
**Approval Statement:** This System Design is now the **approved architecture/design authority** for PrintHub Job Card Tier A. The companion DocType Specification **remains Draft** and is **not safe for coding**. Of the pre-Publication technical gates (Section 25), **P-2, attachment permission validation, and REST/API permission validation are Closed** as of 2026-07-30; **race-safe uniqueness validation, terminal-reason persistence validation, and the Artwork production gate remain open**. **No coding or implementation is authorized by this Approval.**
