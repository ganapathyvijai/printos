...
- **App module:** `Production`, normalized directory `production`, normalized DocType name `printhub_job_card` — resolved at the design/governance level per the Project Owner's 2026-09-09 decision (`../standards/Naming_Registry.md` Section 13h; `ART-RVR-B02`, resolved and moved to `ART-RVR-A12`). This is a design/governance resolution only, not implementation.
