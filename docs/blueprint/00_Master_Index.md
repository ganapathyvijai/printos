...
| 18 | 18_Artwork_Management.md | Artwork management detail | Draft (Version 1.4), prior approved baseline Approval (Version 1.3) — returned to Draft on 2026-09-12 under `../Documentation_Workflow.md` Sections 5 and 7, because Version 1.4's Model 4 Artwork-applicability design direction (Section 2.1) is new normative content that has received no Architecture Review and no Business Review; targeted Architecture Review and Business Review of Section 2.1 are Pending. Approval, Version 1.3 remains the last fully reviewed and Owner-approved version (Project Owner Document Lifecycle Approval granted 2026-08-19 at Version 1.1, carried forward through a bounded reference-only correction and a bounded naming-status synchronization, both on 2026-08-22); prior historical baselines Approval, Version 1.2, Approval, Version 1.1, and Approval, Version 1.0 |
