...
| [../architecture/ERPNext_Gap_Analysis.md](../architecture/ERPNext_Gap_Analysis.md) | 0.1 | The 28 gap records and their classifications | Gap sizing that depends on AR-gated ownership | AR-006, AR-010 (AR-004 and AR-005 Resolved and removed from this list) |
